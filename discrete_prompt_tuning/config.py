...
def simple_config(eval_model, prompt_gen_model):
    ...
    # conf['generation']['num_subsamples'] = 5
    # conf['generation']['num_prompts_per_subsample'] = 1
    ...
    # conf['evaluation']['model']['batch_size'] = eval_batch_size
    ...
    # conf['evaluation']['num_samples'] = 20
